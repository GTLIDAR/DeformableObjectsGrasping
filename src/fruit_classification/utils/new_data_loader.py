...
if __name__ == "__main__":
    ...
    train_dataset = Tactile_Vision_dataset(Fruit_type = ['apple','lemon','plum','orange','tomato'], label_encoding={'apple':'0','lemon':'1','plum':'2','orange':'3','tomato':'4'}, data_path = '/home/yhan389/Desktop/tactile_sensor/data_collection/FruitData/upload')
    train_dataset = Tactile_Vision_dataset(Fruit_type = ['apple'], label_encoding={'apple':'0'}, data_path = '/home/yhan389/Desktop/tactile_sensor/data_collection/FruitData/upload')
    print(len(train_dataset))
    data = train_dataset[30][0]
    label = train_dataset[400][4]
